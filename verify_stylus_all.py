...
for seed in [111,222,333,444,555]:
    ...
    DIST_N = numpy.load("log/seed%d/mcyt/dtw_dist_n%s.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/mcyt/dtw_dist_temp%s.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/bio/dtw_dist_p%s.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/bio/dtw_dist_n%s.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/bio/dtw_dist_temp%s.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/bsds2/dtw_dist_p%s.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/bsds2/dtw_dist_n%s.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/bsds2/dtw_dist_temp%s.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/ebio2/dtw_dist_p%s.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/ebio2/dtw_dist_n%s.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/ebio2/dtw_dist_temp%s.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/ebio1/dtw_dist_p%s_d0.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/ebio1/dtw_dist_n%s_d0.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/ebio1/dtw_dist_temp%s_d0.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/ebio1/dtw_dist_p%s_d1.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/ebio1/dtw_dist_n%s_d1.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/ebio1/dtw_dist_temp%s_d1.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/ebio1/dtw_dist_p%s_d2.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/ebio1/dtw_dist_n%s_d2.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/ebio1/dtw_dist_temp%s_d2.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/ebio1/dtw_dist_p%s_d3.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/ebio1/dtw_dist_n%s_d3.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/ebio1/dtw_dist_temp%s_d3.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
...
for seed in [111,222,333,444,555]:
    DIST_P = numpy.load("log/seed%d/ebio1/dtw_dist_p%s_d4.npy"%(seed, epoch))
    DIST_N = numpy.load("log/seed%d/ebio1/dtw_dist_n%s_d4.npy"%(seed, epoch))
    DIST_TEMP = numpy.load("log/seed%d/ebio1/dtw_dist_temp%s_d4.npy"%(seed, epoch))
    if LOOP:
        for i in range(4):
            datum_p = []
            datum_n = []
